...
export default function Footer() {
  ...
  return (
    <footer className="border-t border-stone-200 bg-stone-50 text-stone-600 dark:border-stone-900 dark:bg-stone-950 dark:text-stone-400 transition-colors duration-300">
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8 md:gap-12">
          ...
          <div className="flex flex-col gap-4">
            <Link href="/" className="flex items-center gap-2.5">
              ...
              <img
                ...
                className="h-8 w-8 rounded-full border border-stone-200 dark:border-stone-800 object-cover shadow-sm"
              />
              <span className="text-lg font-black tracking-wider text-slate-900 dark:text-white">
                UJJWAL <span className="text-amber-500">IRON</span>
              </span>
            </Link>
            ...
            <div className="flex items-center gap-2 rounded-lg bg-stone-200/60 dark:bg-stone-900/50 border border-stone-300 dark:border-stone-800 px-3 py-2 text-xs font-semibold text-emerald-600 dark:text-emerald-400 w-fit">
          ...
          <div>
            ...
            <ul className="space-y-2.5">
              <li>
                <Link href="/" className="text-sm hover:text-amber-500 dark:hover:text-amber-400 transition-colors">Home</Link>
              </li>
              <li>
          ...
          <div>
            ...
            <ul className="space-y-3">
              <li className="flex items-center gap-2.5">
                <Phone size={16} className="text-amber-600 dark:text-amber-500 shrink-0" />
                <a href={`tel:${phone}`} className="text-sm hover:text-amber-550 dark:hover:text-amber-400 transition-colors">{phone}</a>
              </li>
              <li className="flex items-center gap-2.5">
                <Mail size={16} className="text-amber-600 dark:text-amber-500 shrink-0" />
                <a href={`mailto:${email}`} className="text-sm hover:text-amber-550 dark:hover:text-amber-400 transition-colors">{email}</a>
              </li>
            </ul>
          </div>
          ...
          <div>
            ...
            <div className="flex items-start gap-2.5">
              <MapPin size={16} className="text-amber-600 dark:text-amber-500 shrink-0 mt-0.5" />
              <div className="flex flex-col gap-2">
                ...
                <a
                  ...
                  className="text-xs font-bold text-amber-600 dark:text-amber-500 hover:text-amber-500 dark:hover:text-amber-400 flex items-center gap-1 transition-colors mt-1"
                >
